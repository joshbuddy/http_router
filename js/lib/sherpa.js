(function() {
  ...
  root.Sherpa = Sherpa = (function() {
    ...
    Sherpa.prototype.match = function(request) {
      var response;
    ...
    Response = (function() {
      function Response(request, position) {
      ...
      Response.prototype.next = function() {
        if (this.position === this.destinations.length - 1) {
          ...
          return new Response(this.request, this.position + 1).invoke();
        }
      };
      Response.prototype.invoke = function() {
        return this.request.destinations[this.position].destination(this.request.underlyingRequest, this.request.destinations[this.position].params);
      };
      return Response;
    })();
    Node = (function() {
    ...
    Route = (function() {
      ...
      Route.prototype.to = function(destination) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          path = _ref[_i];
          _results.push(this.pathSet = path.parent.add(path));
        }
        return _results;
      };
      Route.prototype.url = function(params) {
        var key, path, pathIdx, query, val, _ref;
        path = void 0;
    ...
    Request = (function() {
      ...
      Request.prototype.splitPath = function(path) {
        return this.path = /^\/?$/.exec(path) ? [] : require('url').parse(path).pathname.split('/');
      };
